met_qaqc <- function(realtime_file,
  ...
  maxTempC = 50 # an upper bound of realistic temperature for the study site in deg C
  minTempC = -50 # an lower bound of realistic temperature for the study site in deg C
